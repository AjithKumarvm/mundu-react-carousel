...
const Home = () => (
  <div>
    <MunduCarousel maxWidth={500} width='100%' height={350} autoPlay onClick={(index) => {console.log('click', index)}} swipePixels={10} autoPlayDuration={2000} slideTime={100} rotateSlides={false} onSlided={(index) => {console.log('slided', index)}}>
      <img
